...
class Code4ChartExp:
    ...
    def run_chart_qa(
        ...
        c4c_chart_qa_fp = os.path.join(self.data_dir_process, "c4c_chart_qa_post_edit.json")
        ...
        for cur_qa_dict in c4c_chart_qa:
            ...
            chart_figure_edit_bar_color = cur_qa_dict["chart_figure_edit_bar_color"]
            vis_code_edit_bar_color = cur_qa_dict["vis_code_edit_bar_color"]
            ...
            for color in color_list:
                ...
                cur_fig_base64 = chart_figure_edit_bar_color[color]
...
Answer:
        ...
        all_qa_results_fp = os.path.join(
            ...
            f"all_qa_results-edit_bar_color-"
            f"{add_code_tag}_{add_ds_info_tag}_{use_cot_tag}_{remove_comments_tag}_{few_shot}.json")
